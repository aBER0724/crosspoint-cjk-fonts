<!--
Font catalog changes should cover one family per pull request. For documentation, tooling, CI, or Pages-only changes, remove the font fields that do not apply.
-->
...
- [ ] This PR changes one font family, or it is a focused maintenance change.
- [ ] The uploaded file is under `community-fonts/<FamilyId>/` and does not use Git LFS.
- [ ] I added, updated, or removed the matching entry in `config/fonts.yaml`.
