## CrossPoint CJK font catalog

This release contains optional `.cpfont` assets for CrossPoint Reader firmware using:

- font manifest schema **2**
- `.cpfont` binary format **4**
- 16 reviewed CJK families
- pre-rendered **8, 10, and 12 pt UI files plus 14, 16, 18, and 22 pt reader files**
